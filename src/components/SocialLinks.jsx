...
const socialLinks = [
  {
    ...
    subText: "Aldrsd",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aldrsd/",
    color: "#0A66C2",
    gradient: "from-[#0A66C2] to-[#6ecfff]",
    isPrimary: true
  },
  {
    name: "Discord",
    ...
    subText: "Aldigamedev",
    icon: BsDiscord,
    url: "https://discordapp.com/users/720948929226866759/",
    color: "#504aff",
    gradient: "from-[#504aff] to-[#668aff]"
  },
  {
    name: "Instagram",
    ...
    subText: "@Aldirsd_",
    icon: Instagram,
    url: "https://www.instagram.com/Aldirsd_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@ArdiAldiGamedev",
    icon: Youtube,
    url: "https://www.youtube.com/channel/UCIFGonzd-c92_-mho7APvTQ",
    color: "#FF0000",
    gradient: "from-[#FF0000] to-[#f734c0]"
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Aldrsd",
    icon: Github,
    url: "https://github.com/aldrsd",
    color: "#943dff",
    gradient: "from-[#943dff] to-[#24292e]"
  },
  {
    name: "TikTok",
    displayName: "Tiktok",
    ...
    url: "https://www.tiktok.com/@aldigamedev",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [discord, instagram, youtube, github, tiktok] = otherLinks;
  useEffect(() => {
    AOS.init({
      once: false,
    });
  ...
  return (
    <div data-aos="fade-left" data-aos-duration="1200" className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3 data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100" className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
        <span className="inline-block w-8 h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full"></span>
        Connect With Me
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <a data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"
          href={linkedIn.url}
          target="_blank"
        ...
        <div 
          className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
                    bg-gradient-to-r ${discord.gradient}`}
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, youtube].map((link, index) => (
            <a  data-aos="fade-right" data-aos-duration="1200" data-aos-delay= {index+3 + "00"}
              key={link.name}
              href={link.url}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, tiktok].map((link, index) => (
            <a data-aos="fade-right" data-aos-duration="1200" data-aos-delay= {index+5 + "00"}
              key={link.name}
              href={link.url}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <p data-aos="fade" data-aos-duration="1200" data-aos-delay="500" className="text-center text-gray-400">Or</p>
        {/*Send Direct Mail*/}
        <a data-aos="fade-right" data-aos-duration="1200" data-aos-delay="600"
          href={"mailto:aldirdeveloper@gmail.com"}
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex items-center justify-between p-4 rounded-lg 
                    bg-white/5 border border-white/10 overflow-hidden
...
>
        ...
        <div 
          className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
                    bg-gradient-to-r from-[#e841d8] to-[#0077B5]`}
        />
    ...
    <p className="absolute text-gray-600 left-0 right-0 bottom-0 h-auto py-5 px-10 text-center">A strong network starts with one connection. I’m just one message away!</p>
      </div>
    </div>
  );
};
